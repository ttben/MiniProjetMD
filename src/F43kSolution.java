...
public class F43kSolution extends AbstractSolution {
	
	public F43kSolution(int profondeur) {
		super(profondeur);
	}
	...
	public void drawSolutionk(Graphics drawingArea, int... arg) {
		...
		//drawingArea.drawRect(ancienX, ancienY, ancienWidth,ancienWidth);
		...
		case 15:
			...
			break;
		case 30:
			this.drawSolutionk(drawingArea, new int[] {nouveauDiametre,nouveauXBas,nouveauYBas, prof,30,iteration,r,g,b+facteurDegrade,(coef*(2)*coefExplosion)});
			...
			this.drawSolutionk(drawingArea, new int[] {nouveauDiametre,nouveauXGauche,nouveauYGauche, prof, 45,iteration,r,g,b+facteurDegrade,(coef*(2)*coefExplosion)});
		
			break;
		case 45:
			this.drawSolutionk(drawingArea, new int[] {nouveauDiametre,nouveauXHaut,nouveauYHaut, prof, 0,iteration,r+facteurDegrade,g+facteurDegrade,b+facteurDegrade,(coef*coefExplosion)});
			this.drawSolutionk(drawingArea, new int[] {nouveauDiametre,nouveauXBas,nouveauYBas, prof, 30,iteration,r+facteurDegrade,g+facteurDegrade,b+facteurDegrade,(coef*2*coefExplosion)});
			this.drawSolutionk(drawingArea, new int[] {nouveauDiametre,nouveauXGauche,nouveauYGauche, prof, 45,iteration,r+facteurDegrade,g+facteurDegrade,b+facteurDegrade,(coef*(2)*coefExplosion)});
