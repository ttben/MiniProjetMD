...
public class FkSolutionTropStyleeDlaMortQuiTueAvecUnNomPerchePckYaPasDeLimiteEnJavaLOLOLOLOL extends AbstractSolution {
	
	public FkSolutionTropStyleeDlaMortQuiTueAvecUnNomPerchePckYaPasDeLimiteEnJavaLOLOLOLOL(int profondeur) {
		super(profondeur);
	}
...
//		System.out.println("\tDiametre :\t" + ancienDiametre);
		drawingArea.drawRect(ancienX, ancienY, ancienDiametre,ancienDiametre);
		
		
		
		if(this.profondeur > 5 && nbIteration == 0) {
			drawingArea.setColor(new Color(0,255,0));
			drawingArea.fillRect(ancienX, ancienY, ancienDiametre,ancienDiametre);
		...
		int nouveauYDroite = (ancienY);
		
		int nouveauXBas =(ancienX)+(ancienDiametre/2) ;
		int nouveauYBas = ancienY + ancienDiametre/2;
		
		int nouveauXHaut =(ancienX);
		int nouveauYHaut = ancienY - nouveauDiametre;
		
		int nouveauXGauche =ancienX  - nouveauDiametre;
		int nouveauYGauche = (ancienY)+(ancienDiametre/2) - nouveauDiametre;
